...
const GroupRecommendationsPage = () => {
  ...
  useEffect(() => {
    if (loading || groupAnime.length === 0) return;
    if (timeLeft <= 0) {
      let maxVotes = -1;
      let winner = null;
    ...
    <div className="min-h-screen bg-primary text-white py-6">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-end mb-4">
          {timeLeft > 0 ? (
            <div className="bg-secondary px-6 py-3 rounded-full shadow-md bg-gray-900">
